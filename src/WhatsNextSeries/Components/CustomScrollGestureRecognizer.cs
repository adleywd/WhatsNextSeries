...
public class CustomScrollGestureRecognizer : ScrollGestureRecognizer
{
    
}
    
// public ScrollGestureRecognizer : GestureRecognizer
// {
...
//                         _trackedRootPoint.X - (_trackedRootPoint.X >= rootPoint.X
//                             ? ScrollStartDistance
//                             : -ScrollStartDistance),
//                         _trackedRootPoint.Y - (_trackedRootPoint.Y >= rootPoint.Y
//                             ? ScrollStartDistance
//                             : -ScrollStartDistance));
//
//                     Capture(e.Pointer);
...
//                     if (CanVerticallyScroll && CanHorizontallyScroll && Math.Abs(speed.X) < InertialScrollSpeedEnd &&
//                         Math.Abs(speed.Y) <= InertialScrollSpeedEnd)
//                     {
//                         EndGesture();
//                         return false;
//                     }
